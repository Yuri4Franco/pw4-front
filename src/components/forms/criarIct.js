...
function FormularioCadastroIct({ onSubmit, onClose, ict }) {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">{ict ? 'Editar ICT' : 'Cadastrar ICT'}</h5>
            <button type="button" className="btn-close" onClick={onClose}></button>
          </div>
          <div className="modal-body">
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              <div className="mb-3">
                <label htmlFor="nome" className="form-label">Nome da ICT</label>
                <input
                  type="text"
                  id="nome"
                  name="nome"
              ...
              <button type="submit" className="btn btn-primary">
                {ict ? 'Salvar Alterações' : 'Cadastrar'}
              </button>
            </form>
          </div>
        </div>
...
export default FormularioCadastroIct;
